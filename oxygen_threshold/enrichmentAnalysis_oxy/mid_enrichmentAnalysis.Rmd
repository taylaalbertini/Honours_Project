...
## export as a cvs
write.csv(placentaF_enriched_export, file = file.path(projectDir, "mid_placentaF_enrichedPathways.csv"))
...
## export as a cvs
write.csv(placentaM_enriched_export, file = file.path(projectDir, "mid_placentaM_enrichedPathways.csv"))
```
