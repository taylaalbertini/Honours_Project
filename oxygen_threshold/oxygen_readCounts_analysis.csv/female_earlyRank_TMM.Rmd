---
title: "female_tissueRank_TMM_oxy"
...
placenta_female_2_TMM <- subset(nCPMs_rank_female, female_placenta_early_rank == "2")
```
...
```{r}
write.csv(placenta_f_depleted_TMM, file = file.path(projectDir, "TMM_placentaF_early_depleted.csv"))
```
