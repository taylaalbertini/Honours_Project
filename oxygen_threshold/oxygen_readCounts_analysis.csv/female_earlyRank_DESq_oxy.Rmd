---
title: "female_earlyRank_DESq_oxy"
...
placenta_female_2_DESq <- subset(nCPMs_rank_female, female_placenta_early_rank == "2")
```
...
```{r}
write.csv(placenta_f_depleted_DESq, file = file.path(projectDir, "DESq_placentaF_early_depleted.csv"))
```