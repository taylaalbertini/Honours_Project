...
cpms_term <- edgeR::cpm(cpm_dgelist_DESq, log = FALSE)
...
## exporting data
write.csv(mean_female_cpms, file = file.path(projectDir, "mean_female_cpms_term_DESq.csv"))

# male
## subsetting data
mean_male_cpms <- subset(mean_sex_term_cpms, startsWith(sex_tissue, "male_"))
## exporting data
write.csv(mean_male_cpms, file = file.path(projectDir, "mean_male_cpms_term_DESq.csv"))
```
